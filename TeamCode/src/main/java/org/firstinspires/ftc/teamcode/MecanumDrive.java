...
import org.firstinspires.ftc.teamcode.interfaces.Localizer;
...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.00205023065094832; //
        public double lateralInPerTick = 0.0016661450970360545;        //  inPerTick;
        public double trackWidthTicks = 6935.025677768576;

        // feedforward parameters (in tick units)`
        public double kS = 0.8399599776840265;
        public double kV = 0.00034223418224742474;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // TODO: make sure your config has an IMU with this name (ca.n be BNO or BHI)
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
        imu = new LazyImu(hardwareMap, "imu", new RevHubOrientationOnRobot(PARAMS.logoFacingDirection, PARAMS.usbFacingDirection));
